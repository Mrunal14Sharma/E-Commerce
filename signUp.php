...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($error) {
        ...
        if ($name != "" && $password != "" && $email != "" && $phone != "") {
            ...
            $query = "select * from user_data where email='$email' or phone='$phone'";
...
<body>
    ...
    <strong>Registration Succussfully Done</strong>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
    </div>';
                    ...
                    <form action="signUp.php" method="post" autocomplete="off">
                        <div class="sign-up">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="submit" name="save" id="save" value="SignUp" class="btn mt-3">
                                </div>
                            </div>
                        </div>
                    </form>
